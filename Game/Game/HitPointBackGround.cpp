...
HitPointBackGround::HitPointBackGround(const Vector2& offset, const Vector2& scale, const float& alpha, const char* texFilePass)
...
HitPointBackGround::~HitPointBackGround()
{
}

void HitPointBackGround::Draw()
{
	// 頂点配列をアクティブに変更
