...
/// ボーンの名前から配列の添え字番号を返す
/// </summary>
/// <param name="HandSocketName"></param>
/// <returns>
/// std::distance(mBones.begin(), itr + 1);	配列の添え字番号
/// </returns>
const int Skeleton::GetBoneIndexFromName(std::string BoneName)const
{
	for (auto itr = mBones.begin(); itr != mBones.end(); itr++)
	{
